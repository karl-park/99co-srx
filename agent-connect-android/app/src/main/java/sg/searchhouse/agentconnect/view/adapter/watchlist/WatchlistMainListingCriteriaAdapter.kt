...
import sg.searchhouse.agentconnect.databinding.ListItemWatchlistMainListingCriteriaBinding
...
class WatchlistMainListingCriteriaAdapter(private val onCriteriaSelected: (item: WatchlistPropertyCriteriaPO) -> Unit) :
    BaseListAdapter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            VIEW_TYPE_CRITERIA -> {
                CriteriaViewHolder(
                    ListItemWatchlistMainListingCriteriaBinding.inflate(
    ...
    class CriteriaViewHolder(val binding: ListItemWatchlistMainListingCriteriaBinding) :
