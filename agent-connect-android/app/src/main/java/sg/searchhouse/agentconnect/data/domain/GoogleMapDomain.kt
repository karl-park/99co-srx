...
class GoogleMapDomain @Inject constructor(val applicationContext: Context) : Domain() {
    override fun getBaseUrl(): String {
        return GoogleEndpoint.GOOGLE_MAP_BASE_URL
    }
    ...
    private fun getAddApiKeyInterceptor(): Interceptor {
        return Interceptor { chain ->
            val key = applicationContext.getString(R.string.api_key_google_maps)
